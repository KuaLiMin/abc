...
function addTop() {
    ...
    /*add top section*/
    $(`<!-- logo --><div class=" d-none d-sm-inline-flex flex-nowrap my-4 mx-0"><button class="pl-4 bg-transparent theLogo pr-2 col-2"><img src="media/logo/main.png" style="object-fit: contain; max-width: 100%;" alt="logo"></button><a class="p-0 homeLink my-auto col-10" href="index.html">Hanabi.co | Your Virtual Companion</a></div><!-- Navbar --> <nav class="navbar bg-transparent navbar-expand-sm navbar p-0 mx-auto mt-3 col-lg-8 col-11 ">
